...
public class User {
    ...
    /**
     * Using synchronization to withdraw money
     * @param name			username
     * @param withdrawal	amount of money to be withrawn
     */
    static synchronized void withdraw(String name, double withdrawal) {
    ...
    /**
     * Using Synchronization to deposit money
     * @param name		username
     * @param deposit	amount to be deposited
     */
    static synchronized void deposit(String name,double deposit){
    ...
    /**
     * Check if the medium of transaction is valid
     * @param addMoneyMedium	medium
     * @throws InvalidMedium	Exception
     */
    public void validMedium(String addMoneyMedium) throws InvalidMedium {
    	if(Arrays.asList(addMoneyMediums).contains(addMoneyMedium)) {
    		this.addMoneyMedium = addMoneyMedium;  
    	}else {
    		throw new InvalidMedium("Invalid medium here");
    	}
    }
